...
use Raven\AtlasPay\Api\WebhookInterface;


class Webhook extends WebhookInterface
{
    ...
    public function execute() {
        ...
        try {
            ...
            $event = json_decode($this->getRequest()->getContent(), true);
            ...
            // Remember that this is a call from AtlasPay's servers and
            // Your customer is not seeing the response here at all
            switch ($event->obj->event) {
                // charge.success
                case 'charge.success':
                    if ('success' === $event->obj->data->status) {
                        $transactionDetails = $this->atlaspay->transaction->verify([
                        ...
                        //if is popup mode, reference is generated by AtlasPay and we provided quoteId instead
